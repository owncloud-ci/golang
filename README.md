...
- [`latest`](https://github.com/owncloud-ci/golang/blob/master/latest/Dockerfile.amd64) available as `owncloudci/golang:latest`
- [`1.16`](https://github.com/owncloud-ci/golang/blob/master/v1.16/Dockerfile.amd64) available as `owncloudci/golang:1.16`
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/owncloud-ci/golang/blob/master/LICENSE) file for details.
